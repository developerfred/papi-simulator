...
export default function ExampleSelector({
	...
	const beginnerExamples = filteredExamples.filter(
		(ex) => ex.level === "beginner",
	);
	const intermediateExamples = filteredExamples.filter(
		(ex) => ex.level === "intermediate",
	);
	const advancedExamples = filteredExamples.filter(
		(ex) => ex.level === "advanced",
	);
	...
	return (
		<Card className="space-y-3">
			...
			<div
				className="border rounded-md max-h-[280px] overflow-y-auto"
