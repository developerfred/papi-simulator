                ...
                return (
                    <>
                        <div className="flex items-center space-x-2 mb-3">
                            ...
                            <h3 className="text-lg font-semibold">Simple Transfer Tutorial</h3>
                        </div>
                        ...
                        <div className="p-3 my-3 rounded" style={{ backgroundColor: getColor('surfaceVariant') }}>
        ...
        >
            {isOpen && (
                <div className="animate-fadeIn">
                    ...
                    <div className="flex justify-end mt-6 pt-3" style={{ borderTop: `1px solid ${getColor('divider')}` }}>
                        <Button
                            variant="ghost"
                            size="sm"
