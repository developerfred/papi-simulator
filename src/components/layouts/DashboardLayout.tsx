...
export default function DashboardLayout({
  ...
  const LogoIcon = () => (
    ...
    >
      <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z" fill={getNetworkColor('primary')} />
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="hidden md:flex items-center gap-4">
              ...
              <Button
                variant="ghost"
                size="sm"
                onClick={() => window.open('https://papi.how/getting-started/', '_blank')}
                icon={<InfoIcon />}
              >
                Documentation
              </Button>
        ...
        <div className="container mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="flex flex-col md:flex-row md:items-center gap-2">
              <div className="flex items-center">
                <span className="mr-2 font-medium">Polkadot API Playground</span>
                <span
              ...
              <span className="text-xs">
                Built with <span className="text-rose-500">❤</span> for the Polkadot ecosystem
              </span>
            </div>

            {/* Footer right section */}
            <div className="flex gap-6 justify-start md:justify-end mt-3 md:mt-0">
              <FooterLink href="https://github.com/polkadot-api/polkadot-api" label="GitHub" />
...
function FooterLink({ href, label }: FooterLinkProps) {
  ...
  return (
    ...
    >
      {label}
      <svg width="12" height="12" viewBox="0 0 24 24" className="ml-1" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
