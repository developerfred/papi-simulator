 ...
 */
export function toChainAmount(network: Network, humanAmount: string | number): bigint {
 ...
 */
export function formatExplorerAddressUrl(network: Network, address: string): string {
 ...
 */
export function formatExplorerBlockUrl(network: Network, blockNumber: number | string): string {
